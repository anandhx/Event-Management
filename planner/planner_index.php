            ...
            <div class="col-md-3 col-lg-2 px-0">
                <div class="sidebar p-3">
                    ...
                    <nav class="nav flex-column">
                        <a class="nav-link active" href="planner_index.php">
                ...
                <div class="main-content p-4">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <div class="d-flex gap-2">
                            <a href="portfolio.php" class="btn btn-primary">
                                <i class="fas fa-edit me-2"></i>Update Portfolio
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-2 mb-3">
                            <div class="stat-card text-center">
                                ...
                                <h4 class="mb-1"><?php echo $planner_stats['total_events']; ?></h4>
                        ...
                        <div class="col-md-2 mb-3">
                            <div class="stat-card text-center">
                                ...
                                <h4 class="mb-1"><?php echo $planner_stats['completed_events']; ?></h4>
                        ...
                        <div class="col-md-2 mb-3">
                            <div class="stat-card text-center">
                                ...
                                <h4 class="mb-1"><?php echo $planner_stats['pending_events']; ?></h4>
                        ...
                        <div class="col-md-2 mb-3">
                            <div class="stat-card text-center">
                                ...
                                <h4 class="mb-1"><?php echo $planner_stats['average_rating']; ?></h4>
                        ...
                        <div class="col-md-2 mb-3">
                            <div class="stat-card text-center">
                                ...
                                <h4 class="mb-1">$<?php echo number_format($planner_stats['total_earnings']); ?></h4>
                        ...
                        <div class="col-md-2 mb-3">
                            <div class="stat-card text-center">
                                ...
                                <h4 class="mb-1"><?php echo $planner_stats['total_reviews']; ?></h4>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6 mb-3">
                            <div class="stat-card text-center">
                                <h4 class="text-primary"><?php echo $planner_stats['this_month_events']; ?></h4>
                                <p class="text-muted mb-0">Events This Month</p>
                            </div>
                        </div>
                        
                        <div class="col-md-6 mb-3">
                            <div class="stat-card text-center">
                                <h4 class="text-success">$<?php echo number_format($planner_stats['this_month_earnings']); ?></h4>
                        ...
                        <div class="col-md-8 mb-4">
                            <div class="card">
                                <div class="card-header bg-primary text-white">
                                    <h5 class="mb-0"><i class="fas fa-calendar me-2"></i>My Assigned Events</h5>
                                </div>
                                <div class="card-body">
                                    ...
                                    <?php else: ?>
                                            ...
                                            <div class="row align-items-center">
                                                <div class="col-md-8">
                                                    ...
                                                    <p class="text-muted small mb-1">
                                                        ...
                                                        Client: <?php echo htmlspecialchars($event['client_name']); ?>
                                                    </p>
                                                    <p class="text-muted small mb-1">
                                        ...
                                        <?php if (count($assigned_events) > 4): ?>
                        ...
                        <div class="col-md-4 mb-4">
                            <div class="card">
                                <div class="card-header bg-success text-white">
                                    <h5 class="mb-0"><i class="fas fa-lightbulb me-2"></i>Available Opportunities</h5>
                                </div>
                                <div class="card-body">
                                    ...
                                    <?php else: ?>
                                        ...
                                        <div class="opportunity-card">
                                            ...
                                            <p class="text-muted small mb-2">
                                                <i class="fas fa-user me-1"></i>
                                                <?php echo htmlspecialchars($opportunity['client_name']); ?>
                                            </p>
                                            <p class="text-muted small mb-2">
                                                <i class="fas fa-calendar me-1"></i>
                                                <?php echo date('M d, Y', strtotime($opportunity['event_date'])); ?>
                                            </p>
                                            <p class="text-muted small mb-2">
                                                <i class="fas fa-dollar-sign me-1"></i>
                                                Budget: $<?php echo number_format($opportunity['budget']); ?>
                                            </p>
                                            <p class="text-muted small mb-2">
                                                <i class="fas fa-tags me-1"></i>
                                                <?php echo ucfirst($opportunity['event_type']); ?>
                                            </p>
                                            <button class="btn btn-success btn-sm w-100" onclick="applyForEvent(<?php echo $opportunity['id']; ?>)">
                                                <i class="fas fa-hand-paper me-1"></i>Apply for Event
                                            </button>
                                        </div>
                                        <?php endforeach; ?>
                                    <?php endif; ?>
    ...
    <script>
        function applyForEvent(eventId) {
            if (confirm('Are you sure you want to apply for this event?')) {
                // Send AJAX request to apply for event
                fetch('apply_for_event.php', {
                    method: 'POST',
                    headers: {
