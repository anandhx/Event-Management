        ...
        <div class="container">
            <nav class="navbar navbar-dark navbar-expand-lg py-lg-0">
                <a href="index.php" class="navbar-brand">
                    <h1 class="text-primary mb-0 display-5">v<span class="text-white">ms</span></h1>
                </a>
                ...
                <div class="collapse navbar-collapse me-n3" id="navbarCollapse">
                    <div class="navbar-nav ms-auto">
                        ...
                        <a href="profile_management.php"  class="nav-item nav-link" >profile</a>
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu m-0 bg-primary">
                                <a href="request_service.php" class="dropdown-item">request service</a>
                                <a href="service_history.php" class="dropdown-item">service History</a>
                        ...
                        <a href="communication.php" class="nav-item nav-link">Send Message</a>
