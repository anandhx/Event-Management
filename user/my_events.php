...
// Fetch user's events
$events_query = "SELECT e.*, ec.category_name, ep.company_name as planner_name 
                 FROM events e 
                 LEFT JOIN event_categories ec ON e.category_id = ec.category_id 
                 LEFT JOIN event_planners ep ON e.planner_id = ep.planner_id 
                 WHERE e.client_id = ? 
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="event-card p-4">
                                        <div class="d-flex justify-content-between align-items-start mb-3">
                                            <h5 class="fw-bold mb-0"><?php echo htmlspecialchars($event['event_title']); ?></h5>
