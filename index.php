...
if (isset($_GET['logout']) && $_GET['logout'] == 'success') {
    echo '<div class="notification success">You have successfully logged out.</div>';
}
?>

<!-- Hero Section -->
<section class="hero-section" style="background: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('assets/img/hero-bg.jpg') center/cover no-repeat;">
            ...
            <div class="col-lg-6">
                <div class="hero-content text-start">
                    <h1 class="hero-title fade-in">
                        Create Unforgettable <span class="text-gradient">Events</span>
                    </h1>
                    ...
                    <div class="d-flex gap-3 flex-wrap">
                        <a href="user/register.php" class="hero-btn btn-custom btn-primary-custom">
                            <i class="fas fa-user-plus me-2"></i>Get Started
                        </a>
                        <a href="#services" class="hero-btn btn-custom" style="background: rgba(255,255,255,0.2); color: white; border: 2px solid white;">
            ...
            <div class="col-lg-6">
                <div class="text-center slide-in-right">
                    <div class="position-relative">
                        <div class="bg-gradient-primary rounded-custom p-4 d-inline-block shadow-custom">
                            <i class="fas fa-calendar-check fa-6x text-white"></i>
                        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="text-center">
                    <span class="tab active" id="loginTab" onclick="toggleTab('login')">Sign In</span>
                    <span class="tab" id="signupTab" onclick="toggleTab('signup')">Sign Up</span>
                </div>

                <!-- Login Form -->
                <form id="loginForm" style="display: block;" onsubmit="return validateLoginForm()">
                    <div class="mb-3">
